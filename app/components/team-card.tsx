...
export default function TeamCard({ team, removable }: Props) {
  return (
    <div className="group relative flex h-36 w-40 select-none flex-col justify-end rounded-3xl border border-solid border-black/5 bg-primary dark:bg-dark dark:text-white py-4 text-center font-medium text-black/50">
