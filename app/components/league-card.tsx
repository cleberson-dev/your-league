...
export default function LeagueCard({ name, teamsCount }: Props) {
  return (
    <div className="relative flex h-52 w-56 cursor-pointer select-none flex-col justify-end rounded-3xl border border-solid border-black/5 bg-primary py-5 text-center font-medium text-black/50">
